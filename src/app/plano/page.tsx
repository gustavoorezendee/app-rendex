    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Plano Free */}
          <div
            className={`bg-white dark:bg-slate-800 rounded-2xl p-6 border-2 transition-all ${
              !isPremium
          ...
          >
            ...
            {!isPremium && (
              <div className="bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 px-4 py-2 rounded-lg text-center font-medium">
                Plano Atual
              </div>
            )}
          </div>
          ...
          {/* Plano Premium */}
          <div
            className={`bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl p-6 border-2 transition-all ${
              isPremium
          ...
          >
            ...
            {isPremium ? (
              <div className="bg-amber-100 dark:bg-amber-900/40 text-amber-900 dark:text-amber-100 px-4 py-2 rounded-lg text-center font-medium mb-3">
                Plano Atual
              </div>
            ) : null}
