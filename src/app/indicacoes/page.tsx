      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#7A9CC6] to-[#F5C6C6] flex items-center justify-center">
        ...
        {/* Card principal */}
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-xl space-y-8">
          {/* Ícone central */}
          <div className="flex justify-center">
            <div className="relative">
              <div className="w-32 h-32 rounded-full bg-gradient-to-br from-[#F5C6C6] to-[#8A7CA8] flex items-center justify-center animate-pulse">
                <Gift className="w-16 h-16 text-white" />
              </div>
              <div className="absolute -top-2 -right-2">
                <Sparkles className="w-8 h-8 text-[#F5C6C6]" />
              </div>
            </div>
          </div>
          ...
          {/* Benefícios futuros */}
          <div className="bg-gradient-to-r from-[#D6EAF8] to-[#FFE8E8] rounded-2xl p-8 space-y-4">
            <h3 className="text-xl font-bold text-[#7A9CC6] text-center mb-6">
              O que você vai ganhar:
            </h3>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <span className="text-[#F5C6C6] text-2xl">✓</span>
          ...
          <div className="text-center pt-6">
            ...
            <Link
              href="/home"
              className="inline-block py-3 px-8 bg-gradient-to-r from-[#7A9CC6] to-[#8A7CA8] text-white font-semibold rounded-xl shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300"
            >
              Voltar para Home
            </Link>
          </div>
